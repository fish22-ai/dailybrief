...
# 的 System.Drawing 重画：字号 0.46×边长（汉字墨迹约为字号的 0.85，实际四周留白
# 约 22%），既是任何尺寸下都耐看的留白，也稳稳落在 maskable 的 80% 安全圆里，
# 安卓切圆形/方形都不会切到字。改配色或字号只动下面两个数，别去改 PNG。
Add-Type -AssemblyName System.Drawing

$scale = 0.46                       # 字号 = 边长 × 这个数
